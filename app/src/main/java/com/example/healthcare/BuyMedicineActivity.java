...
public class BuyMedicineActivity extends AppCompatActivity {
    private String[][] packages =
            {
                    ...
                    {"HealthVit Chromium Picolinate 200mcg Capluse","","","","305"},
    ...
    private String[] package_details={
            ...
            "Relieves the symptoms of a bacterical throat infection and soothes the recovery process\n" +
                    "Provides a warm and comforting feeling during sore throat",
            "reduces the risk of calcium deficiency, rickets, and Osteoprosis\n" +
                    "Promots mobility and flexibility of joints",
